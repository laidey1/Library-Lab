...
public class Library {
	...
	if(!existBook) {
	System.out.println("Sorry we dont have that in our store");
}
}
public void returnBook(String bookTitle) {
	...
	for(Book book :this.books){
		if(book.getTitle().equals(bookTitle)) {
			if(book.isBorrowed()) {
				book.returned();
				System.out.println("you have returned this book: " + bookTitle);
			}else {
	...
	System.out.println("Library opens at 9:00 am to 5:00pm");
}
